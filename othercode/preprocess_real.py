#coding:utf-8
"""
Edited on Sar Mar 28 18:00:00 2020
...
def prepro(d_path, length=864, number=1000, normal=True, rate=[0.7, 0.2, 0.1], enc=True, enc_step=28,featrue = 'DE_time'):
    ...
    # 从所有.mat文件中读取出数据的字典
    data = capture(original_path=d_path, fea=featrue )
    # 将数据切分为训练集、测试集
...
if __name__ == "__main__":
    #path = r'data\0HP'
    path = r'C:\Users\86132\Desktop\train'
